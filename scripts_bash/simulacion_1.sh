...
#SBATCH --job-name=simulacion_1      # do not change
#SBATCH --output=~/Desktop/Produccion-Tesis/Output/simulacion_1.out         # do not change

module load python/3.9.6 gurobi/9.5.2 mpi4py
source ~/Desktop/env_gurobi/bin/activate

cd ~/Desktop/Produccion-Tesis
python ~/Desktop/Produccion-Tesis/simulacion1.py
